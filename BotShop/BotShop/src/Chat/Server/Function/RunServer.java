package Chat.Server.Function;

//import Chat.Server.Function.Client;
//import Chat.Server.Function.Method;
...
public class RunServer extends javax.swing.JFrame {
        ...
        run = new Thread(new Runnable() {
            ...
            public void run() {
                try {
                    ...
                    JOptionPane.showMessageDialog(RunServer.this, e, "Error", JOptionPane.ERROR_MESSAGE);
                    //e.printStackTrace();
                }
            }
        });
    ...
    private void cmdStartActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmdStartActionPerformed
        try {
            int c = JOptionPane.showConfirmDialog(this, "Are you sure to run server now", "Start Server", JOptionPane.YES_NO_OPTION, JOptionPane.QUESTION_MESSAGE);
            if (c == JOptionPane.YES_OPTION) {
                startServer();
            }
        } catch (Exception e) {
