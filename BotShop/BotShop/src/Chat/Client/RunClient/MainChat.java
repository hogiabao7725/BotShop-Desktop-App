package Chat.Client.RunClient;

import Chat.Client.Function.FileChooser;
import Chat.Client.Function.Method;
import Chat.Client.Function.Scrolling;
...
import Chat.Client.MySwing.Emoji;
import Chat.Client.MySwing.Emoji_Group;
import Chat.Client.MySwing.Get_Box;
import Chat.Client.MySwing.Friend_Box;
import Chat.Client.MySwing.Get_Box_New;
import Chat.Client.MySwing.Get_Emoji;
import Chat.Client.MySwing.Get_Emoji_New;
import Chat.Client.MySwing.Get_File;
import Chat.Client.MySwing.Get_File_New;
import Chat.Client.MySwing.Get_Photo_Box;
import Chat.Client.MySwing.Get_Photo_Box_New;
import Chat.Client.MySwing.Send_Box;
import Chat.Client.MySwing.Send_Box_New;
import Chat.Client.MySwing.Send_Emoji;
import Chat.Client.MySwing.Send_Emoji_New;
import Chat.Client.MySwing.Send_File;
import Chat.Client.MySwing.Send_File_New;
import Chat.Client.MySwing.Send_Photo_Box;
import Chat.Client.MySwing.Send_Photo_Box_New;
...
public class MainChat extends javax.swing.JFrame {
    ...
    public MainChat(String role, String email) {
        this.role = role;
        this.email = email;
        initComponents();
        open();
    ...
    private void open() {
        setIconImage(new ImageIcon(getClass().getResource("/Chat/Client/Icon/chat.png")).getImage());
        popUp.add(panel);
        ...
        panelGroup.add(eg1);
        //Emoji_Group eg2 = new Emoji_Group("", 28);
    ...
    private void initComponents() {
        ...
        panel = new Chat.Client.MySwing.Panel();
        cmdPhoto = new Chat.Client.MySwing.Button();
        cmdEmoji = new Chat.Client.MySwing.Button();
        cmdFile = new Chat.Client.MySwing.Button();
        popUp_emoji = new javax.swing.JPopupMenu();
        panel_emoji = new Chat.Client.MySwing.Panel();
        panel1 = new Chat.Client.MySwing.Panel();
        ...
        panelMix = new Chat.Client.MySwing.Panel();
        panel2 = new Chat.Client.MySwing.Panel();
        ...
        cmdLogOut = new Chat.Client.MySwing.Button();
        ...
        cmdPhoto.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Chat/Client/Icon/photo.png"))); // NOI18N
        cmdPhoto.setPressedIcon(new javax.swing.ImageIcon(getClass().getResource("/Chat/Client/Icon/photo_click.png"))); // NOI18N
        ...
        cmdEmoji.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Chat/Client/Icon/emoji.png"))); // NOI18N
        cmdEmoji.setPressedIcon(new javax.swing.ImageIcon(getClass().getResource("/Chat/Client/Icon/emoji_click.png"))); // NOI18N
        ...
        cmdFile.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Chat/Client/Icon/file.png"))); // NOI18N
        cmdFile.setPressedIcon(new javax.swing.ImageIcon(getClass().getResource("/Chat/Client/Icon/file_click.png"))); // NOI18N
        ...
        cmdSend.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Chat/Client/Icon/send.png"))); // NOI18N
        ...
        cmdSend.setPressedIcon(new javax.swing.ImageIcon(getClass().getResource("/Chat/Client/Icon/send_click.png"))); // NOI18N
        ...
        cmdMore.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Chat/Client/Icon/more.png"))); // NOI18N
        cmdMore.setBorder(null);
        cmdMore.setContentAreaFilled(false);
        cmdMore.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        cmdMore.setFocusable(false);
        cmdMore.setPressedIcon(new javax.swing.ImageIcon(getClass().getResource("/Chat/Client/Icon/more_click.png"))); // NOI18N
    ...
    private void cmdSendActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmdSendActionPerformed
        if (txt.getName().equals("have") && !txt.getText().equals("")) {
            try {
                ...
                txt.setText("");
                txt.grabFocus(); // Set the focus state (mouse point) on the component
            } catch (Exception e) {
            }
        }
    ...
    private void cmdLogOutActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmdLogOutActionPerformed
        ...
        if (c == JOptionPane.YES_OPTION) {
            try {
                ...
                ChatLoginSystem.removeActiveUser(user);
                this.dispose();
            } catch (Exception e) {
            }
        }
    ...
    private void formWindowClosing(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowClosing
        announcement.setText("<html>Close button is disabled!<br>"
                    + "Please press the \"Sign out\" button located at the bottom left corner of the screen.</html>");
        announcement.setFont(new Font("Segoe UI Semibold", Font.BOLD, 20));
        showAnnouncement(announcement.getText(), "Warning", JOptionPane.WARNING_MESSAGE);
    ...
    public void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            @Override
            public void run() {
                new MainChat(role, email).setVisible(true);
            }
        });
    }

    // Variables declaration - do not modify//GEN-BEGIN:variables
    private Chat.Client.MySwing.Button cmdEmoji;
    private Chat.Client.MySwing.Button cmdFile;
    private Chat.Client.MySwing.Button cmdLogOut;
    private javax.swing.JButton cmdMix;
    private javax.swing.JButton cmdMore;
    private Chat.Client.MySwing.Button cmdPhoto;
    private javax.swing.JButton cmdSend;
    private javax.swing.JLabel jLabel1;
    private javax.swing.JLabel jLabel2;
    private javax.swing.JLabel lbStatus;
    private Chat.Client.MySwing.Panel panel;
    private Chat.Client.MySwing.Panel panel1;
    private Chat.Client.MySwing.Panel panel2;
    ...
    private Chat.Client.MySwing.Panel panelMix;
    private javax.swing.JPanel panel_bg;
    private Chat.Client.MySwing.Panel panel_emoji;
    ...
    public void main(Object object, String role, String name) {
